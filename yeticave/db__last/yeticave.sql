...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 30 2022 г., 11:41
...
(27, '2022-05-20', 'Компас на карабине с держателем для бутылки', 'Скоро здесь появится подробное описание товара. А пока полистайте фото или зайдите в наши магазины, чтобы посмотреть на товар своими глазами и узнать о нем больше.', 'img/kopmass.jpg', 500, '2022-05-31', 150, 1, 1, 6);
...
(1, '2022-05-15', 'gmail@gmail.com', 'Itashiro', '$2y$10$MJETbJceh5wGJI4MKVn3veMAyP29RQrkKlmM7.5ZQMoac40HP8sui', 'avatar.jpg', '88005553535'),
(2, '2022-05-16', 'user@gmail.com', 'user', '$2y$10$MJETbJceh5wGJI4MKVn3veMAyP29RQrkKlmM7.5ZQMoac40HP8sui', 'i.jpg', '88005553536'),
(3, '2022-05-30', 'oleg@gmail.com', 'Oleg', '$2y$10$MJETbJceh5wGJI4MKVn3veMAyP29RQrkKlmM7.5ZQMoac40HP8sui', 'ava.jpg', '12345(pass)'),
(9, '2022-05-30', 'hyoka@gmail.com', 'Hyoka', '$2y$10$OIwpcUwk0B0TBdKdyuWbVO4jiF0VJlljTQ69eRx3znNSeaR6gyy8q', 'ava2.jpg', 'nani(pass)');
...
--
ALTER TABLE `bid`
  MODIFY `id_bid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
